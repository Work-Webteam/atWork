 ...
 */
class CorporateNewsEmp extends FormBase {

  /**
   * {@inheritdoc}
   */
  public function getFormId() {
    return 'corporate_news_emp';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $entity = $entityManager->getStorage('paragraph')->create([ 'type' => 'corporate_news_emp' ]);
    $form_state->set('entity', $entity);

    /** @var \Drupal\Core\Entity\Display\EntityFormDisplayInterface $form_display */
    $form_display = $entityManager->getStorage('entity_form_display')->load('paragraph.corporate_news_emp.default');
